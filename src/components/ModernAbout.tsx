                    ...
                    <div className="flex-1">
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-xl md:text-2xl leading-relaxed font-light mb-16 tracking-tight">
                                Premium painting by <span className="text-black font-semibold">PainterG</span>. Specialized in
                                transforming residential setups and commercial spaces. Elevating environments
                            ...
                            <div className="grid grid-cols-2 gap-y-12 gap-x-12">
                                <div className="space-y-3">
                                    ...
                                    <p className="text-sm text-gray-400 font-medium">10+ Years // Master Painters</p>
                                </div>
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3 text-black">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <p className="text-sm text-gray-400 font-medium">Residential & Commercial</p>
                                </div>
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3 text-black">
                                        <Rocket size={18} strokeWidth={2.5} />
                                        <span className="text-[10px] font-black uppercase tracking-widest">Mission</span>
                                    </div>
                                    <p className="text-sm text-gray-400 font-medium">Bringing Spaces to Life</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
